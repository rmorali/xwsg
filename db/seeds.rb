...
color = "##{([*('A'..'F'),*('7'..'9')]-%w(0 1 I O)).sample(6).join}"
...
coruscant = Planet.create(name: 'Coruscant', sector: 2, x: 475, y: 250, credits: 0)
dagobah = Planet.create(name: 'Dagobah', sector: 4, x: 475, y: 1150, credits: 0)
deathstar = Planet.create(name: 'Death Star', sector: 2, x: 700, y: 250, credits: 0)
endor = Planet.create(name: 'Endor', sector: 1, x: 250, y: 700, credits: 0)
felucia = Planet.create(name: 'Felucia', sector: 3, x: 1150, y: 250, credits: 0)
...
hoth = Planet.create(name: 'Hoth', sector: 1, x: 475, y: 700, credits: 0)
ilum = Planet.create(name: 'Ilum', sector: 1, x: 250, y: 250, credits: 0)
kamino = Planet.create(name: 'Kamino', sector: 3, x: 1375, y: 700, credits: 0)
kashyyyk = Planet.create(name: 'Kashyyyk', sector: 3, x: 1263, y: 475, credits: 0)
kessel = Planet.create(name: 'Kessel', sector: 3, x: 1038, y: 475, credits: 0)
kuat = Planet.create(name: 'Kuat', sector: 4, x: 925, y: 700, credits: 0)
mandalore = Planet.create(name: 'Mandalore', sector: 2, x: 588, y: 475, credits: 0)
mon_calamari = Planet.create(name: 'Mon Calamari', sector: 3, x: 1375, y: 250, credits: 0)
mustafar = Planet.create(name: 'Mustafar', sector: 1, x: 138, y: 925, credits: 0)
mygeeto = Planet.create(name: 'Mygeeto', sector: 2, x: 588, y: 25, credits: 0)
naboo = Planet.create(name: 'Naboo', sector: 4, x: 588, y: 925, credits: 0)
nal_hutta = Planet.create(name: 'Nal Hutta', sector: 3, x: 1150, y: 700, credits: 0)
ord_ibanna = Planet.create(name: 'Ord Ibanna', sector: 1, x: 363, y: 925, credits: 0)
polis_massa = Planet.create(name: 'Polis Massa', sector: 1, x: 25, y: 700, credits: 0)
rattatak = Planet.create(name: 'Rattatak', sector: 1, x: 138, y: 475, credits: 0)
rhen_var = Planet.create(name: 'Rhen Var', sector: 3, x: 1038, y: 25, credits: 0)
...
utapau = Planet.create(name: 'Utapau', sector: 4, x: 700, y: 1150, credits: 0)
yavin = Planet.create(name: 'Yavin', sector: 2, x: 813, y: 25, credits: 0)
